<div class="container-fluid bg-white mt-5">
    <div class="row">
        ...
        <div class="col-lg-4 p-4 ">
            ...
            <a href="contact.php" class="d-inline-block mb-2 text-dark text-decoration-none">Conatct Us</a><br>
...
<h6 class="text-center bg-dark text-white p-3 m-0">Designed and Developed by Hotel Royal Villa</h6>
    ...
    register_form.addEventListener('submit', (e) => {
        ...
        xhr.onload = function() {
            if (this.responseText == 'pass_mismatch') {
                ...
                alert('success', 'Registration successful,Email verification Link sent to mail!!!');
                register_form.reset();
            }
        }
    ...
    forgot_form.addEventListener('submit', (e) => {
        ...
        xhr.onload = function() {
            if (this.responseText == 'inv_email') {
                ...
                alert('success', 'Password Reset Link sent to mail!!!');
                forgot_form.reset();
            }
        }
