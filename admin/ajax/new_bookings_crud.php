...
if (isset($_POST['get_bookings'])) {
    ...
    $query = "SELECT bo.*, bd.*FROM `booking_order` bo INNER JOIN `booking_details` bd ON 
   bo.booking_id=bd.booking_id WHERE (bo.user_id LIKE ? OR bd.phonenum LIKE ? OR bd.user_name LIKE ?)
...
if (isset($_POST['assign_room'])) {
    ...
    //2 row affected so instead of 2 retuen 1
    echo ($res == 2) ? 1 : 0;
}
