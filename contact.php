        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 mb-5 px-4">
                ...
                <?php 
                    if($contact_r['tw']!=''){
                        echo <<<data
                            <a href="$contact_r[tw]" class="d-inline-block text-dark fs-8 me-2">
                ...
                <a href="<?php echo $contact_r['fb'] ?>" class="d-inline-block text-dark fs-8 me-2">
                    <i class="bi bi-facebook me-1"></i>
                </a>
                <a href="<?php echo $contact_r['insta'] ?>" class="d-inline-block text-dark fs-8 ">
