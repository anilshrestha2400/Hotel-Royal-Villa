...
<body class="bg-light">
                ...
                <div class="bg-white p-3 p-md-4 rounded shadow-sm">
                    ...
                    <h5 class="mb-3 fw-bold">Change Password</h5>
                        ...
                        <div class="col-md-6 mb-3">
                                ...
                                <input type="password" name="new_pass" class="form-control shadow-none" required min="6">
                            </div>
                            <div class="col-md-6 mb-4">
                                <label class="form-label">Confirm Password</label>
                                <input type="password" name="confirm_pass" class="form-control shadow-none" required min="6">
                            </div>
                        </div>
    ...
    <script>
        ...
        info_form.addEventListener('submit', function(e) {
            ...
            xhr.open("POST", "ajax/profile_crud.php");
            xhr.onload = function() {
